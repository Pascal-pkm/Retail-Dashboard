...
| täglich | Passantenfrequenzen Oldenburg (4 Innenstadt-Zählstellen) | Standort (eigener Tab) | echte Fußgängerzahlen, dl-de/by-2-0, von der Stadt selbst re-publizierte Hystreet-Sensordaten – siehe COMPLIANCE.md Abschnitt 6 |
...
**Echte Fußgängerdaten – Passantenfrequenzen Oldenburg:** Bei der Küsten-Recherche zusätzlich gefunden: Die Stadt Oldenburg veröffentlicht ihre eigenen Hystreet-Sensordaten (4 Innenstadt-Zählstellen, tagesgenau seit 2020) offen unter dl-de/by-2-0 auf ihrem eigenen Open-Data-Portal – eine andere rechtliche Situation als der direkte Hystreet-Zugriff (siehe COMPLIANCE.md Abschnitt 6). Dafür gibt es einen eigenen Dashboard-Tab „Fußgänger" (gleicher Aufbau wie „Karte (Radverkehr)": Gesamt-Index mit Vorjahresvergleich, Karte, Einzelstandorte). Neues Modul `scripts/sources/fussgaenger.py`, Jahresarchiv-Cadence analog zu Düsseldorf.
